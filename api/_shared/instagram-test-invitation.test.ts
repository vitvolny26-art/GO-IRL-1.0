...
import { handleInstagramTestInvitation } from "./instagram-test-invitation.js";
...
const request = (body: unknown, token = "instagram-trigger-token") => new Request(
...
describe("Instagram test invitation trigger", () => {
  beforeEach(() => {
    runtimeEnv.INSTAGRAM_TEST_TRIGGER_TOKEN = "instagram-trigger-token";
  });

  afterEach(() => {
    delete runtimeEnv.INSTAGRAM_TEST_TRIGGER_TOKEN;
    vi.restoreAllMocks();
  });
