-- Keep terminal failed notifications out of the canonical delivery claim loop.
-- A failed row is retryable only when next_attempt_at is explicitly scheduled.
