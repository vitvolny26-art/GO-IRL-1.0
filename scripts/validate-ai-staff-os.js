...
const cases = [
  ...
  ['D Automation engineering', baseMission('Fix n8n workflow retry', 'Repair webhook execution and idempotency'), ['Project Coordinator', 'Automation Engineer', 'Tech Lead', 'QA Lead']],
];
