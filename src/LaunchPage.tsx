  ...
  return (
    <div className="launch-root launch-home">
      ...
      <main className="launch-content">
        {showWebAuth ? (
          <section className="launch-auth-row" aria-label={t.google}>
            <button className="launch-google-auth" type="button" onClick={() => void startGoogleAuth()}>{t.google}</button>
