...
describe("hydrateReminderDelivery", () => {
  it("builds trusted event, calendar, and map links for an active opted-in identity", () => {
    const result = hydrateReminderDelivery({
      ...
      identity: {
        ...
        last_inbound_at: "2026-07-23T08:00:00Z",
      },
      event,
  ...
  it.each([
    ...
    },
    {
      ...
      identity: { provider_user_id: "123", status: "revoked" as const, consented_at: "2026-07-23T09:00:00Z", last_inbound_at: null },
      event,
      reason: "provider_identity_revoked",
    },
    {
      name: "missing consent",
      identity: { provider_user_id: "123", status: "active" as const, consented_at: null, last_inbound_at: null },
      event,
      reason: "provider_consent_missing",
    },
    {
      name: "deleted event",
      identity: { provider_user_id: "123", status: "active" as const, consented_at: "2026-07-23T09:00:00Z", last_inbound_at: null },
      event: null,
