...
- Previous: [`02-platform-architecture.md`](02-platform-architecture.md)
- Next: [`04-modules-architecture.md`](04-modules-architecture.md)
- Schema audit: [`../DATABASE_SCHEMA_AUDIT.md`](../DATABASE_SCHEMA_AUDIT.md)
