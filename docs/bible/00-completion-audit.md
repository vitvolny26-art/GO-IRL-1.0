...
| Overall Bible 1.0 completion | 99% |

The remaining 1% consists of product, production, or owner decisions that documentation cannot make on its own.
...
| Book | File(s) | Status |
|---|---|---|
| I — Foundation | [`01-foundation/`](01-foundation/) | Complete |
| II — Platform Architecture | [`02-platform-architecture.md`](02-platform-architecture.md) | Complete |
| III — Database and Supabase Boundaries | [`03-database-and-supabase-boundaries.md`](03-database-and-supabase-boundaries.md) | Complete with one open schema/product decision |
...
## Partially resolved external decisions

| Decision | Current safe wording | Owner |
|---|---|---|
| Activity Chat lifetime | Temporary event coordination; current migration behavior wins until a separate approved SQL/code task changes it. | Product Owner + Supabase Steward |
...
| Governance automation revision | Current GitHub `main` remains authoritative until any replacement workflow documentation is merged. | Chief Archivist |
